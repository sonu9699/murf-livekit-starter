...
![Aarogya Saathi Banner](https://raw.githubusercontent.com/sonu9699/murf-livekit-starter/main/aarogya_saathi_banner.png)
...
### Technology Stack
*   **Audio Transport**: LiveKit (WebRTC real-time transport for ultra-low latency audio streaming).
...
#VoiceForBharat #10DaysOfVoiceAgents #VoiceAI #MurfAI #AIForBharat #Healthcare #LiveKit #Gemini
