...
- Clinic and Appointment Booking (`transfer_to_appointments`): Call this immediately if the caller wants to book, schedule, reschedule, or cancel a doctor, clinic, PHC, or hospital appointment. You do not handle appointments yourself; you must transfer the user to the specialist agent.
